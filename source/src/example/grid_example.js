   ...
   const onChangewidth = e => {
    setwidth(e.target.value);
          ...
          return(
            ...
            height: <input value={height} onChange={({ target: { value} }) => setheight(value)} />
            rowheight: <input value={rowheight} onChange={({ target: { value } }) => setrowheight(value)} /><br/>
            columnwidth: <input value={columnwidth} onChange={({ target: { value } }) => setcolumnwidth(value)} />
            row: <input value={row} onChange={({ target: { value } }) => setrow(value)} />
            column: <input value={column} onChange={({ target: { value } }) => setcolumn(value)} />
