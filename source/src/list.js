...
class List extends Component {
    ...
    __initProperties(){
      ...
      this.listData.columnOption = [...Object.values(this.state["column-option"])].map((itemrow)=>{return Object.values(itemrow)});
      ...
      colspanCount=0;
      this.listData.columninfo = this.listData.columnOption.map((rowitem,rowitemindex)=>{
            leftpos=0;
